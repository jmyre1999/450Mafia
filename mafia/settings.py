...
AUTH_USER_MODEL = 'mafia.UserProfile'
...
#     DEFAULT_FILE_STORAGE = 'mafia.storages.MediaStorage'
# else:
STATIC_URL = '/static/'

STATIC_ROOT = '/mafia/static/'

django_heroku.settings(locals())

MEDIA_URL = '/userprofile/'

MEDIA_ROOT = os.path.join(BASE_DIR, 'mafia/static')
