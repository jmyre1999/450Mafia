...
ROOT_URLCONF = '450mafia.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['450mafia/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = '450mafia.wsgi.application'
...
AUTH_USER_MODEL = '450mafia.UserProfile'
...
STATIC_ROOT = '/450mafia/static/'

django_heroku.settings(locals())

MEDIA_URL = '/userprofile/'

MEDIA_ROOT = os.path.join(BASE_DIR, '450mafia/static')
